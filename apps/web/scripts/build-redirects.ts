#!/usr/bin/env bun
// Generate apps/web/redirects.json — the canonical list of HTTP redirects served by Next.js.
// Run with: bun apps/web/scripts/build-redirects.ts
...
console.log(`Wrote ${all.length} redirects to apps/web/redirects.json`);
