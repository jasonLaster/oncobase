...
- The sticky header combines the visible date window, diagnostic overview, and calendar axis.
...
- Timeline controls, filter, count, and status legend live below the timeline rows.
