...
`apps/wiki-vite/e2e/diagnostic-timeline.spec.ts`. Route, header, sidebar, legacy
redirect, and diagnostics subpage regressions are covered by
`apps/wiki-vite/e2e/diagnostics-regression.spec.ts`.
...
`apps/wiki-vite/e2e/diagnostic-timeline.spec.ts` verifies:
...
`apps/wiki-vite/e2e/diagnostics-regression.spec.ts` verifies:
