#!/usr/bin/env bun
// Generate apps/wiki-vite/redirects.json — canonical aliases used by the Vite reader and server.
// Run with: bun apps/wiki-vite/scripts/build-redirects.ts
...
const sourceRedirects: Redirect[] = [
  ...
  { source: "/asco/presentations/263034-p-rad-analysis", destination: "/asco/presentations/263034-p-rad/analysis" },
  { source: "/asco/presentations/263034-p-rad-slides-ocr", destination: "/asco/presentations/263034-p-rad/slides-ocr" },
  { source: "/asco/presentations/263034-p-rad-transcript", destination: "/asco/presentations/263034-p-rad/transcript" },
  ...
  { source: "/sources/meeting-notes/05-12---bernardo-personalis-leukopak-call-overview-public", destination: "/sources/meeting-notes/05-12---bernardo-personalis-leukopak-call-overview" },
  { source: "/sources/meeting-notes/05-12---bernardo-personalis-leukopak-call-formatted-public", destination: "/sources/meeting-notes/05-12---bernardo-personalis-leukopak-call-formatted" },
  { source: "/sources/meeting-notes/05-12---bernardo-personalis-leukopak-call-raw-public", destination: "/sources/meeting-notes/05-12---bernardo-personalis-leukopak-call-raw" },
...
console.log(`Wrote ${all.length} redirects to apps/wiki-vite/redirects.json`);
