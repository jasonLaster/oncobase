#!/usr/bin/env bun
// Generate apps/app/redirects.json — canonical aliases used by the Vite reader and server.
...
console.log(`Wrote ${all.length} redirects to apps/app/redirects.json`);
