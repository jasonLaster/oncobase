...
export type WikiSensitiveLockProps = Omit<ComponentProps<"span">, "children">;

/** Lock affordance shown beside the title of a sensitive page in both readers. */
export function WikiSensitiveLock({ className, ...props }: WikiSensitiveLockProps) {
  return (
    <span
