...
const SKIPPABLE_EXACT_PATHS = new Set([
  ...
  "apps/web/scripts/admin/changed-slugs.ts",
  "apps/web/scripts/publish/bootstrap.ts",
  "apps/web/scripts/publish/build-vault-starter.ts",
  "apps/web/src/app/(main)/admin/access/access-data.ts",
  "apps/web/src/lib/chat-page-reader.test.ts",
  "apps/web/src/lib/chat-page-reader.ts",
  "apps/web/src/lib/page-metadata.ts",
  "apps/web/src/lib/render-markdown.ts",
  "apps/web/src/lib/wikilinks.test.ts",
  "apps/web/src/lib/wikilinks.ts",
