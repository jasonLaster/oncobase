...
import { createWikiViteHandler } from "../apps/wiki-vite/server/app-shell.js";
import { requestFromIncoming, sendWebResponse } from "../apps/wiki-vite/server/wiki-api.js";
...
export default async function wikiViteAppShell(req: IncomingMessage, res: ServerResponse) {
  try {
    ...
    console.error("[wiki-vite-vercel-app]", error);
